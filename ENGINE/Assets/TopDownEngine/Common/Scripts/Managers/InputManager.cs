...
{	
	...
	public class InputManager : MMSingleton<InputManager>
	{
        ...
        /// the run follow the mouse
        public MMInput.IMButton MouseFollowButton { get; protected set; }
		/// the dash button
		...
		protected virtual void InitializeButtons()
		{
			...
			//ButtonList.Add(MouseFollowButton = new MMInput.IMButton (PlayerID, "MouseFollow", MouseFollowButtonDown, MouseFollowButtonPressed, MouseFollowButtonUp));
		...
		public virtual void MouseFollowButtonDown()		{ MouseFollowButton.State.ChangeState (MMInput.ButtonStates.ButtonDown); }
		public virtual void MouseFollowButtonPressed()		{ MouseFollowButton.State.ChangeState (MMInput.ButtonStates.ButtonPressed); }
		public virtual void MouseFollowButtonUp()			{ MouseFollowButton.State.ChangeState (MMInput.ButtonStates.ButtonUp); }
