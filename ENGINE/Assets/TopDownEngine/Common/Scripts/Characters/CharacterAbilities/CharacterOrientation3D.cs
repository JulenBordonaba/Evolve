    ...
    public class CharacterOrientation3D : CharacterAbility
    {
        ...
        protected virtual void ComputeRelativeSpeeds()
        {
            ...
            if (_characterMovement != null)
            {
                try
                {
                    maxSpeed = _characterMovement.stats.MovementSpeed;
                }
                catch
                {
        ...
        public override void UpdateAnimator()
        {
            ...
            MMAnimatorExtensions.UpdateAnimatorFloat(_animator, _remappedSpeedNormalizedAnimationParameter, _remappedSpeed.magnitude, _character._animatorParameters);
        }
    }
}