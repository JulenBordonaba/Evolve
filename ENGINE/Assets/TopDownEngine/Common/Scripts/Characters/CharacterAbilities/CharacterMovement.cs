...
{	
	...
	public class CharacterMovement : CharacterAbility 
	{
        ...
        /// the character stats rerference
		...
		protected virtual void SetMovement()
		{
            ...
            {
                _movementSpeed = Mathf.Lerp(_movementSpeed, stats.MovementSpeed * MovementSpeedMultiplier, _acceleration * Time.deltaTime);
            }
            else
            {
                _movementSpeed = stats.MovementSpeed * MovementSpeedMultiplier;
            }
			...
			if (_movementVector.magnitude > stats.MovementSpeed)
			{
				_movementVector = Vector3.ClampMagnitude(_movementVector, stats.MovementSpeed);
			}
		...
		{
            MMAnimatorExtensions.UpdateAnimatorFloat(_animator, _speedAnimationParameter, Mathf.Abs(_controller.CurrentMovement.magnitude),_character._animatorParameters);
